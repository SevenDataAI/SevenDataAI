...
<p align="center">
  AI Writing Tools · AI Workflow · Productivity Automation · Data Agent
</p>

<p align="center">
  <a href="https://github.com/SevenDataAI/realtext-zh">RealText-ZH</a>
  ·
...
**第一类是所有人都会遇到的 AI 使用问题。**

比如 AI 写出来的内容太像 AI、表达太空、文档太散、重复工作太多。

**第二类是更工程化的 AI 落地问题。**

比如怎么把重复、低价值、容易出错的工作，变成 AI 可以稳定执行的 workflow。
...
### [`realtext-zh`](https://github.com/SevenDataAI/realtext-zh)

中文 AI 味清理和改写工具。

它解决的是一个全行业问题：很多人用 AI 写文章、文档、简历、产品介绍、销售话术、小红书笔记，但最终文本看起来太像 AI。
